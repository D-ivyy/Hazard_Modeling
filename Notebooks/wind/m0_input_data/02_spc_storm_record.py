...
#
# > Plan: [`m0_input_data.md`](../../../docs/plans/wind/m0_input_data.md) · Hazard definition (EF bins, μ):
# > [`layer0/01_hazard_definition`](../layer0/01_hazard_definition.ipynb) · Coupling (tornado = areal):
# > [`discussion/wind/02`](../../../docs/extra/discussion/wind/02_coupling_buckets_and_wind.md) · Principle:
...
# shown, with the bias made explicit. Sources are public, no auth ([DD-WN-3](../../../docs/plans/wind/decisions.md)).
...
# > fetch handles the zip. Raw files cached under `data/wind/raw/` (gitignored); re-runs reuse the cache (idempotent).
...
print("raw national records cached under data/wind/raw/ (gitignored).\n")
