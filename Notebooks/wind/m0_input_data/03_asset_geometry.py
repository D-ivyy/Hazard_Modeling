...
#
# > Plan: [`m0_input_data.md`](../../../docs/plans/wind/m0_input_data.md) · Coupling (areal vs per-turbine):
...
#   filtered to turbines **inside the polygon**. Raw pulls cached under `data/wind/raw/` (gitignored).
...
print("\nraw USWTDB pulls cached under data/wind/raw/ (gitignored).")
