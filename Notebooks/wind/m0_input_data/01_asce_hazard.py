...
#
# > Plan: [`m0_input_data.md`](../../../docs/plans/wind/m0_input_data.md) · Layer-0 event definition:
# > [`00_hazard_definition`](../../../docs/plans/wind/00_hazard_definition.md) · Coupling deep-dive:
# > [`discussion/wind/02`](../../../docs/extra/discussion/wind/02_coupling_buckets_and_wind.md) ·
...
# are M1+. The wind *event* was already **authored** in [layer-0](../../../docs/plans/wind/00_hazard_definition.md);
# M0 only *meets the evidence*. Source = the public **ASCE Hazard Tool**, no auth, no key
# ([DD-WN-3](../../../docs/plans/wind/decisions.md)).
...
#
# Full register: [`assumptions.md`](../../../docs/plans/wind/assumptions.md).
...
# > the EVT return-level curve at fixed exceedance probabilities (cf. [discussion/03](../../../docs/extra/discussion/wind/03_hazard_definition_and_thresholds.md) §6).
...
ROOT = _repo_root()
DATA_DIR = ROOT / "data" / "wind"
RAW_BASE = DATA_DIR / "raw"          # data/wind/raw/<slug>/  — gitignored (data/*/raw/)
...
# - **Reproducibility:** raw `identify` JSON cached under `data/wind/raw/<slug>/` (gitignored); a manifest is kept.
...
print(f"raw ASCE identify JSON cached under data/wind/raw/<slug>/ (gitignored).\n")
for a in ASSETS:
...
# tornado *spine* is therefore the **SPC path record** ([`02`](02_spc_storm_record.ipynb), [DD-WN-5](../../../docs/plans/wind/decisions.md)).
